...
--               c:/fpga/printer/printer.gen/sources_1/bd/design_1/ip/design_1_button_0_0/design_1_button_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of design_1_button_0_0_button is
  ...
  signal \debounce_clock0_carry__2_i_1_n_0\ : STD_LOGIC;
  signal \debounce_clock0_carry__2_i_2_n_0\ : STD_LOGIC;
  signal \debounce_clock0_carry__2_i_3_n_0\ : STD_LOGIC;
  signal \debounce_clock0_carry__2_i_4_n_0\ : STD_LOGIC;
  ...
  signal \debounce_clock0_carry__3_i_1_n_0\ : STD_LOGIC;
  signal \debounce_clock0_carry__3_i_2_n_0\ : STD_LOGIC;
  signal \debounce_clock0_carry__3_i_3_n_0\ : STD_LOGIC;
...
debounce_clock0_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      S(2) => debounce_clock0_carry_i_2_n_0,
      S(1) => debounce_clock0_carry_i_3_n_0,
...
\debounce_clock0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \debounce_clock0_carry__0_i_1_n_0\,
      S(2) => \debounce_clock0_carry__0_i_2_n_0\,
      S(1) => \debounce_clock0_carry__0_i_3_n_0\,
      S(0) => \debounce_clock0_carry__0_i_4_n_0\
    );
...
\debounce_clock0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \debounce_clock0_carry__2_i_1_n_0\,
      S(2) => \debounce_clock0_carry__2_i_2_n_0\,
      S(1) => \debounce_clock0_carry__2_i_3_n_0\,
      S(0) => \debounce_clock0_carry__2_i_4_n_0\
    );
\debounce_clock0_carry__2_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__2_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__2_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__2_i_4\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => '0',
      S(2) => \debounce_clock0_carry__3_i_1_n_0\,
      S(1) => \debounce_clock0_carry__3_i_2_n_0\,
      S(0) => \debounce_clock0_carry__3_i_3_n_0\
    );
\debounce_clock0_carry__3_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__3_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\debounce_clock0_carry__3_i_3\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
entity design_1_button_0_0 is
  ...
  attribute X_CORE_INFO of design_1_button_0_0 : entity is "button,Vivado 2021.2";
