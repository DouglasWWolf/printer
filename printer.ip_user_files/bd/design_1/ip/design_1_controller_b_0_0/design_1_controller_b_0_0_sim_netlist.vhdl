...
architecture STRUCTURE of design_1_controller_b_0_0_controller_b is
  ...
  signal \fifo_out[70]_i_1_n_0\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of \fifo_out_reg[70]\ : label is "xilinx.com:interface:fifo_write:1.0 FIFO_WRITE WR_DATA";
  attribute X_INTERFACE_MODE : string;
  attribute X_INTERFACE_MODE of \fifo_out_reg[70]\ : label is "master";
  attribute X_INTERFACE_INFO of fifo_wr_en_reg : label is "xilinx.com:interface:fifo_write:1.0 FIFO_WRITE WR_EN";
begin
  FIFO_OUT(0) <= \^fifo_out\(0);
\fifo_out[70]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\fifo_out_reg[70]\: unisim.vcomponents.FDRE
     port map (
      C => CLK,
      CE => '1',
...
entity design_1_controller_b_0_0 is
  port (
    ...
    RESETN : in STD_LOGIC;
    BUTTON : in STD_LOGIC;
    FIFO_OUT : out STD_LOGIC_VECTOR ( 527 downto 0 );
...
architecture STRUCTURE of design_1_controller_b_0_0 is
  ...
  signal \^fifo_out\ : STD_LOGIC_VECTOR ( 67 to 67 );
  attribute X_INTERFACE_INFO : string;
  ...
  attribute X_INTERFACE_INFO of FIFO_OUT : signal is "xilinx.com:interface:fifo_write:1.0 FIFO_WRITE WR_DATA";
begin
  FIFO_OUT(527) <= \<const0>\;
  FIFO_OUT(526) <= \<const0>\;
  FIFO_OUT(525) <= \<const0>\;
  ...
  FIFO_OUT(72) <= \<const0>\;
  FIFO_OUT(71) <= \<const0>\;
  FIFO_OUT(70) <= \^fifo_out\(67);
  FIFO_OUT(69) <= \<const0>\;
  FIFO_OUT(68) <= \<const0>\;
  FIFO_OUT(67) <= \^fifo_out\(67);
  FIFO_OUT(66) <= \<const0>\;
  FIFO_OUT(65) <= \<const0>\;
  FIFO_OUT(64) <= \<const0>\;
  FIFO_OUT(63) <= \<const0>\;
  FIFO_OUT(62) <= \^fifo_out\(67);
  FIFO_OUT(61) <= \^fifo_out\(67);
  FIFO_OUT(60) <= \<const0>\;
  FIFO_OUT(59) <= \<const0>\;
  FIFO_OUT(58) <= \<const0>\;
  FIFO_OUT(57) <= \<const0>\;
  FIFO_OUT(56) <= \^fifo_out\(67);
  FIFO_OUT(55) <= \<const0>\;
  FIFO_OUT(54) <= \^fifo_out\(67);
  FIFO_OUT(53) <= \^fifo_out\(67);
  FIFO_OUT(52) <= \^fifo_out\(67);
  FIFO_OUT(51) <= \<const0>\;
  FIFO_OUT(50) <= \^fifo_out\(67);
  FIFO_OUT(49) <= \^fifo_out\(67);
  FIFO_OUT(48) <= \^fifo_out\(67);
  FIFO_OUT(47) <= \<const0>\;
  FIFO_OUT(46) <= \^fifo_out\(67);
  FIFO_OUT(45) <= \^fifo_out\(67);
  FIFO_OUT(44) <= \<const0>\;
  FIFO_OUT(43) <= \^fifo_out\(67);
  FIFO_OUT(42) <= \<const0>\;
  FIFO_OUT(41) <= \^fifo_out\(67);
  FIFO_OUT(40) <= \^fifo_out\(67);
  FIFO_OUT(39) <= \<const0>\;
  FIFO_OUT(38) <= \^fifo_out\(67);
  FIFO_OUT(37) <= \^fifo_out\(67);
  FIFO_OUT(36) <= \<const0>\;
  FIFO_OUT(35) <= \^fifo_out\(67);
  FIFO_OUT(34) <= \<const0>\;
  FIFO_OUT(33) <= \<const0>\;
  FIFO_OUT(32) <= \^fifo_out\(67);
  FIFO_OUT(31) <= \<const0>\;
  FIFO_OUT(30) <= \^fifo_out\(67);
  FIFO_OUT(29) <= \^fifo_out\(67);
  FIFO_OUT(28) <= \<const0>\;
  FIFO_OUT(27) <= \^fifo_out\(67);
  FIFO_OUT(26) <= \^fifo_out\(67);
  FIFO_OUT(25) <= \^fifo_out\(67);
  FIFO_OUT(24) <= \<const0>\;
  FIFO_OUT(23) <= \<const0>\;
  FIFO_OUT(22) <= \^fifo_out\(67);
  FIFO_OUT(21) <= \^fifo_out\(67);
  FIFO_OUT(20) <= \^fifo_out\(67);
  FIFO_OUT(19) <= \<const0>\;
  FIFO_OUT(18) <= \<const0>\;
  FIFO_OUT(17) <= \^fifo_out\(67);
  FIFO_OUT(16) <= \^fifo_out\(67);
  FIFO_OUT(15) <= \^fifo_out\(67);
  FIFO_OUT(14) <= \<const0>\;
  FIFO_OUT(13) <= \<const0>\;
  FIFO_OUT(12) <= \<const0>\;
  FIFO_OUT(11) <= \<const0>\;
