...
architecture STRUCTURE of design_1_controller_0_0_controller is
  ...
  signal \fifo_out[118]_i_1_n_0\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of \fifo_out_reg[118]\ : label is "xilinx.com:interface:fifo_write:1.0 FIFO_WRITE WR_DATA";
  attribute X_INTERFACE_MODE : string;
  attribute X_INTERFACE_MODE of \fifo_out_reg[118]\ : label is "master";
...
\fifo_out[118]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\fifo_out_reg[118]\: unisim.vcomponents.FDRE
     port map (
      C => CLK,
      CE => '1',
...
architecture STRUCTURE of design_1_controller_0_0 is
  ...
  signal \^fifo_out\ : STD_LOGIC_VECTOR ( 116 to 116 );
  attribute X_INTERFACE_INFO : string;
...
begin
  ...
  FIFO_OUT(120) <= \<const0>\;
  FIFO_OUT(119) <= \<const0>\;
  FIFO_OUT(118) <= \^fifo_out\(116);
  FIFO_OUT(117) <= \<const0>\;
  FIFO_OUT(116) <= \^fifo_out\(116);
  FIFO_OUT(115) <= \<const0>\;
  FIFO_OUT(114) <= \<const0>\;
  FIFO_OUT(113) <= \^fifo_out\(116);
  FIFO_OUT(112) <= \^fifo_out\(116);
  FIFO_OUT(111) <= \<const0>\;
  FIFO_OUT(110) <= \^fifo_out\(116);
  FIFO_OUT(109) <= \^fifo_out\(116);
  FIFO_OUT(108) <= \<const0>\;
  FIFO_OUT(107) <= \^fifo_out\(116);
  FIFO_OUT(106) <= \<const0>\;
  FIFO_OUT(105) <= \<const0>\;
  FIFO_OUT(104) <= \<const0>\;
  FIFO_OUT(103) <= \<const0>\;
  FIFO_OUT(102) <= \^fifo_out\(116);
  FIFO_OUT(101) <= \^fifo_out\(116);
  FIFO_OUT(100) <= \<const0>\;
  FIFO_OUT(99) <= \<const0>\;
  FIFO_OUT(98) <= \^fifo_out\(116);
  FIFO_OUT(97) <= \<const0>\;
  FIFO_OUT(96) <= \^fifo_out\(116);
  FIFO_OUT(95) <= \<const0>\;
  FIFO_OUT(94) <= \^fifo_out\(116);
  FIFO_OUT(93) <= \^fifo_out\(116);
  FIFO_OUT(92) <= \^fifo_out\(116);
  FIFO_OUT(91) <= \<const0>\;
  FIFO_OUT(90) <= \<const0>\;
  FIFO_OUT(89) <= \^fifo_out\(116);
  FIFO_OUT(88) <= \<const0>\;
  FIFO_OUT(87) <= \<const0>\;
  FIFO_OUT(86) <= \^fifo_out\(116);
  FIFO_OUT(85) <= \^fifo_out\(116);
  FIFO_OUT(84) <= \<const0>\;
  FIFO_OUT(83) <= \^fifo_out\(116);
  FIFO_OUT(82) <= \<const0>\;
  FIFO_OUT(81) <= \<const0>\;
  FIFO_OUT(80) <= \^fifo_out\(116);
  FIFO_OUT(79) <= \<const0>\;
  FIFO_OUT(78) <= \<const0>\;
  FIFO_OUT(77) <= \<const0>\;
  FIFO_OUT(76) <= \<const0>\;
